...
if not paths.filep(rewtr_t7filename) then
  ...
  local files = {'aida_train.csv', 'aida_testA.csv', 'aida_testB.csv', 
	...
	'wikiann-test-et.csv', 'wikiann-train-et.csv',
	'wikiann-test-fi.csv', 'wikiann-train-fi.csv',
	'wikiann-test-hr.csv', 'wikiann-train-hr.csv',
	'wikiann-test-sl.csv', 'wikiann-train-sl.csv'}
