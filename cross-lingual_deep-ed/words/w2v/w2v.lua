...
elseif opt.word_vecs == 'fasttext' then
  -- FastText downloaded from: https://github.com/facebookresearch/MUSE
  if opt.language == 'en' then
    w2v_txtfilename = default_path .. 'FastText/wiki.multi.en.vec'
    w2v_t7filename = opt.root_data_dir .. 'generated/wiki.multi.en.t7'
    w2v_reader = 'words/w2v/glove_reader.lua'
  elseif opt.language == 'fi' then
    w2v_txtfilename = default_path .. 'FastText/wiki.multi.fi.vec'
    w2v_t7filename = opt.root_data_dir .. 'generated/wiki.multi.fi.t7'
    w2v_reader = 'words/w2v/glove_reader.lua'
  elseif opt.language == 'hr' then
     w2v_txtfilename = default_path .. 'FastText/wiki.multi.hr.vec'
     w2v_t7filename = opt.root_data_dir .. 'generated/wiki.multi.hr.t7'
     w2v_reader = 'words/w2v/glove_reader.lua'
  elseif opt.language == 'et' then
     w2v_txtfilename = default_path .. 'FastText/wiki.multi.et.vec'
     w2v_t7filename = opt.root_data_dir .. 'generated/wiki.multi.et.t7'
     w2v_reader = 'words/w2v/glove_reader.lua'
  elseif opt.language == 'sl' then
     w2v_txtfilename = default_path .. 'FastText/wiki.multi.sl.vec'
     w2v_t7filename = opt.root_data_dir .. 'generated/wiki.multi.sl.t7'
     w2v_reader = 'words/w2v/glove_reader.lua'
  end
