...
local function gen_test_wikiann(dataset) 

  print('\nGenerating test data from ' .. dataset .. ' set ')

  local path = opt.root_data_dir .. 'basic_data/test_datasets/wikiann/' .. dataset .. '/test/'

  out_file = opt.root_data_dir .. 'generated/test_train_data/wikiann-test-' .. dataset .. '.csv'
...
local function gen_train_wikiann(dataset) 

  print('\nGenerating train data from ' .. dataset .. ' set ')

  local path = opt.root_data_dir .. 'basic_data/test_datasets/wikiann/' .. dataset .. '/train/'

  out_file = opt.root_data_dir .. 'generated/test_train_data/wikiann-train-' .. dataset .. '.csv'
  ouf = assert(io.open(out_file, "w"))
  ...
  while (line) do
    if (not line:find('document docName=\"')) then
      if line:find('<annotation>') then
        ...
        assert(line:find('</annotation>'), line .. ' ' .. cur_ent_title)
...
gen_train_wikiann('et')
gen_train_wikiann('fi')
gen_train_wikiann('hr')
gen_train_wikiann('sl')
