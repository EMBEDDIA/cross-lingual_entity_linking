...
---------------- word vectors
cmd:option('-word_vecs', 'fasttext', 'Word vectors type: glove | w2v (Word2Vec) | fasttext')
abbv['-word_vecs'] = ''

---------------- language
cmd:option('-language', 'en', 'Language of the document: en | et | fi | hr | sl')
abbv['-language'] = ''
...
cmd:option('-load_ed_model', '', 'Saved pretrained model filename from folder $DATA_PATH/generated/ed_models/.')
